...
export default () => (
  <Post>
    ...
    <P>
      It{`'`}s ambition was to be the WordPress of the JavaScript
    ...
    <P>
      Although I didn{`'`}t really knew much about running JS anywhere
      ...
      knowledge spread by helpful community members.
    </P>

    <P>
      Today I{`'`}m building all kinds of products with
      ...
      lot left for me to understand.
    </P>

    <P>And that{`'`}s why I{`'`}m writing this article today!</P>

    <P>
      I noticed that creating things for ZEIT not only consumes most
      ...
      of responsibility and I like it a lot!
    </P>

    <P>
      To make this process easier for me, I completely left Muffin
      out of the equation and it just sat around.
    </P>

    <P>
      I thought I could just continue with it sometime in the
    ...
    <P>
      Since all of its parts are licensed under MIT, everyone
      can just fork it and maybe even continue maintaining it. But
      starting today, I personally won{`'`}t write any more code for it.
    </P>

    <P>
      The <Link href="https://github.com/muffin">code</Link> and
      the
      {' '}
      <Link href="http://muffin.cafe/">website</Link>
      {' '}
      will stay online though!
    </P>

    <P>
      Wrapping up this post, I{`'`}d like to thank all people who helped
      me shape the application with useful critique (especially my old
      teams for sharing their experience with me).
    </P>
