...
export default () => (
  <Post>
    ...
    <P>
      Then it suddenly hit me: I was so dizzy that I completely ignored that the baggage will go straight to the next plane if the current airport is just a stopover for you.
      {' '}
      {`"`}
      Very nice, Leo... Very. Nice.
      {`"`}
      , I thought.
    </P>
    ...
    <P>
      Outside of that section, I found actual people from the airport team and told them about my problem (first class folks, because they were the only ones that spoke proper english). They got me another special black phone which I used to directly call someone from the
      {' '}
      {`"`}
      behind the scenes
      {`"`}
    ...
    <P>
      Thankfully, they
      {`'`}
      ve been very helpful and easy to handle, so we somehow managed to find my stuff only based on the information that I had in my mind. Once the conversation was over, my baggage was placed in terminal 2F. So I thought, the only thing left to do was to quickly walk over to it and get my clothing back. But no! Terminal 2F was about 20 minutes away from where I landed, because I had to take the bus, which also stopped at another terminal.
    </P>

    <P>
      Once I finally arrived there, I wasn
      {`'`}
      t able to straight to the conveyor belt for the baggage, because the doors were only one-way, of course. So I spent another 30 minutes talking to security people, who I explained my situation to and who then opened a special door for me, so that I could get to my stuff.
    </P>
    ...
    <P>
      Who would have thought that getting out of a stopover would be so hard? Well, that was it. I didn
      {`'`}
      t want to visit Paris anymore, I just wanted to go back home and write code in peace. Therefore, my next step was to get a train ticket to my hometown Bamberg (in Bavaria), which costed a whole lotta money.
    </P>
    ...
    <P>
      ...
      {`'`}
      t stand it anymore: I took the next exit and left the train in Brussels, Belgium.
    </P>
    ...
    <P>
      After I ate something a tiny shop, I left the train station thinking that I could potentially get a taxi to drive me closer to my hometown, so that my mum could pick me up (being in a car is much more comfortable when you
      {`'`}
      re feeling dizzy than being in in a train that
      {`'`}
      s going 300 km/h, because you can stop whenever you want and eventually even make little pauses at restaurants to eat and drink something).
    </P>
    ...
    <P>
      ...
      {`"`}
      {' '}
      and his phone number on the top, which - of course - had nothing to do with an actual license.
    </P>

    <P>
      After that, I started walking away from him, trying to get to a real taxi. He kept following me asking where I wanted to go to, but once I told him where I was living, he suddenly got pretty quiet. Why? Because real taxis drive you as far as you want them to (at least in most countries I know), fakes ones fail after a few kilometres, because it
      {`'`}
      s too heavy job for them.
    </P>
    ...
    <P>
      ...
      {`'`}
      {' '}
      streets and mountains with his car (he wasn
      {`'`}
      t driving responsible at all and constantly shouting stuff and calling people, shouting at them and so on), I started getting doubts. Should I really trust this guy with my life? He might as well drive me to somewhere else or do whatever the hell with my baggage.
    </P>

    <P>
      So I lied to him and told him that a friend would pick me up and the train station (that
      {`'`}
      s where we left), because I didn
      {`'`}
      t want to hurt his feelings. He took a lot of detours and eventually managed to get back on the way to where we came from.
    </P>

    <P>
      While we were driving, I started getting that bad feeling in stomach again (because he was going so reckless at full speed), so I asked him for a paper bag. But I couldn
      {`'`}
      t even manage to get the message through, because I started choking on the word, which was why I made hand signs.
    </P>
    ...
    <P>
      I knew I had to call someone to pick me up in Brussels or maybe even spend a night there, because it was getting very late. Therefore I tried to find a hotel where I could spend a few hours without getting fooled by criminals. I wandered through the city near the train station and I couldn
      {`'`}
      t find a single one suggested by Siri that wasn
      {`'`}
    ...
    <P>
      ...
      Hell yeah
      {`"`}
      , I thought. I placed my baggage there and asked the team if I could stay for a few hours, before I called my mum and asked her if she could get me. However, she wasn
      {`'`}
      t very enthusiastic about that (of course, she would have to drive to Brussels, which would take about 5-6 hours). I tried to convince her with several techniques, but it simply didn
      {`'`}
      t work. I had to book a night!
    </P>
    ...
    <P>
      These few days were probably some of the shittiest in my whole life! But that doesn
      {`'`}
      t matter too much, since I
      {`'`}
