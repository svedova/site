...
E[attr*="xyz"] { display: block; }`}</Code>
    ...
    <Code>{`Die E-Elemente, deren "attr"-Attribut gesetzt ist (gleich, mit welchem Wert).
...
Die E-Elemente, deren "attr"-Attribut die Zeichenkette "xyz" enthält`}</Code>

    <P>Hier ein kurzes Beispiel zur Anwendung solche Attribut-Selektoren:</P>

    <Code language="html">{`<h4 lang="de">Deutsche Überschrift</h4>
<h4 lang="fr">Französische Überschrift</h4>
<h4 lang="dk">Dänische Überschrift</h4>`}</Code>
