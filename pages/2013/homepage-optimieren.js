...
export default () => (
  <Post>
    ...
    <P>
      Im heutigen Zeitalter, indem die Medien schon
      ...
      oder Google Plus vorzubereiten.
    </P>

    <P>
      Zunächst einmal ist es wichtig, die Programme und Online-Dienste
      einzugrenzen, für die das Werk optimiert werden soll. Dort
      muss mit Bedacht gewählt werden, da die Optimierung natürlich
      nicht zuviel Arbeit machen sollte.
    </P>

    <P>
      Ich habe mir für mein
      {' '}
      <Link href="http://www.frewhost.net">Hosting-Projekt</Link>
      {' '}
      den
      ...
      mit der Optimierung los gehen:
    </P>

    <P>
      Facebook bietet glücklicherweiße einen Generator, indem im
    ...
    <P>
      Nun kommen wir zur Optimierung an Windows 8. Dort lassen
...
<meta name="msapplication-TileImage" content="windowsico.png"/>`}
    ...
    <P>
      Zunächst wird der Titel der Seite gesetzt, dann die Hintergrundfarbe
