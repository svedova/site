...
export default () => (
  <Post>
    ...
    <P>
      Vor einigen Tagen hatte ich mich mit einem
      ...
      ermöglichen, dass Daten schneller geladen werden können.
    </P>

    <P>
      Dann hatte er mir von einer Software für Apache 2.2
      ...
      {' '}
      einen
      Vorteil zu ziehen. Somit sah ich mir die Erweiterung mal an.
    </P>

    <P>
      Zunächst einmal möchte ich überhaupt das Wirken der
      ...
      wird derzeit von Google Chrome und Firefox unterstützt.
    </P>

    <P>
      Klingt eigentlich ganz gut, nicht war? Schade ist
      ...
      Debian
      {' '}
      <Link href="https://developers.google.com/speed/spdy/mod_spdy/">
        hier
      </Link>
      {' '}
      herunterladen. Ich
      werde es demnächst auch einmal genauer prüfen.
    </P>

    <P>
      Einer der entscheidenden Faktoren für die Steigerung der Geschwindigkeit durch SPDY ist das
      ...
      und Komprimierung. Weniger Verbindungen müssen aufgebaut werden.
    </P>

    <P>
      Derzeit wird die Erweiterung von Google entwickelt. Diese
      ...
      Betaversion des Apache-Moduls.
    </P>

    <P>
      Ein kleines Video, in dem das Programm im Zusammenhang mit
