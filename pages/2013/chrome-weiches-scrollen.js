...
export default () => (
  <Post>
    ...
    <P>
      Vor einigen Tagen habe ich offiziell meinen Browser
      ...
      nicht mehr, weshalb ich Googles Chrome zu meinem Hauptbrowser machte.
    </P>

    <P>
      Mittlerweile nutze ich den Browser schon ein paar Wochen und
      komme eigentlich ganz gut damit klar. Das Interface ist viel
      klarer aufgebaut, und hält somit den wichtigsten Teil (den
      Inhaltsbereich) im Vordergrund, wodurch man auch mehr Gefallen an Webseiten findet.
    </P>

    <P>
      Allerdings gibt es eine kleine Sache bei Google Chrome, die
      ...
      gibt, dieses Smooth-Scrolling zu aktivieren - notfalls auch per Plugin.
    </P>

    <P>
      Letztendlich fand ich eine Seite, auf der beschrieben wurde, wie
    ...
    <P>
      Somit war es nur notwendig, in einem neuen
      Tab
      {' '}
      <InlineCode>chrome://flags</InlineCode>
      {' '}
      einzugeben, enter zu drücken, und
      ...
      schon klappt es - das {`"`}weiche{`"`} Scrollen.
    </P>

    <P>
      Das ganze ist allerdings nur auf Windows und Linux
      ...
      gearbeitet wird und daher solch eine Funktion gar nicht nötig ist.
    </P>
  </Post>
)
