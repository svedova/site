...
export default () => (
  <Post>
    ...
    <P>
      Heute möchte ich euch meinen neuen Lieblings-Reader
      für RSS-Feeds vorstellen: {`"`}Feeder{`"`} heißt der gute.
    </P>

    <P>
      Als vor einigen Monaten der RSS-Reader von Google offiziell
      ...
      zu bedienendes Plugin für Google Chrome.
    </P>

    <P>
      Nach ein paar Wochen der Nutzung hatte ich mir schon
      ...
      Interface und die Nutzerfreundlichkeit.
    </P>

    <Quote by="feeder.co">
      Your feed reading experience is about to get a
      boost. Whether you are a professional or personal user this new
      addition to feeder will enable you to faster consume your
      favorite feeds. Scroll down to learn more.
    </Quote>

    <P>
      Um das Plugin nutzen zu können, muss es im Grunde nur auf
      ...
      Seite des Plugins zu lesen.
    </P>

    <P>
      Wie schon oben kurz angedeuted verfügt Feeder über ein sehr schönes
      ...
      herauszufiltern und zu speichern.
    </P>

    <P>
      Wenn man dann erstmal ein paar RSS-Feeds gespeichert hat, muss
    ...
    <P>
      Natürlich hat man auch die Möglichkeit, einen bestimmten Beitrag
