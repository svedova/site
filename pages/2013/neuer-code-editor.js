...
export default () => (
  <Post>
    ...
    <P>
      Lange ist es her, seitdem ich zum letzen mal den Editor
      ...
      bisherigen Code-Editor
      {' '}
      <Link href="http://notepad-plus-plus.org">Notepad++</Link>
      {' '}
      gefunden.
    </P>

    <P>
      Ich rede von <Link href="http://brackets.io">Brackets</Link>, einem
      komplett quelloffenen Editor für Entwicklungen im Web. Derzeit
      wird das Projekt offiziell von Adobe betreut und steht
      somit auch unter deren MIT-Lizenz.
    </P>

    <P>
      Das praktische an der Software ist, dass absolut
      jeder der Ahnung vom Programmieren hat, mitwirken kann. Dies
      fördert natürlich die UX des Projekts, da genau das
      geboten wird, was der Nutzer gerne hätte.
    </P>

    <P>
      Weitergehend bieten sich somit auch fast unbegrenzte
      ...
      mit wenigen Klicks installiert werden können.
    </P>

    <P>
      Mir ist aufgefallen, dass das Projekt nicht nur unter dem
    ...
    <P>
      Alles in allem funktioniert die Anwendung
      wunderbar, alles läuft flüssig. Bisher konnte ich noch
      keine Bugs oder ähnliches erkennen.
    </P>
  </Post>
)
