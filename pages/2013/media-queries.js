...
export default () => (
  <Post>
    ...
    <P>
      Vor einigen Tagen hatte ich einen Artikel über Responsive Design
      ...
      wird, sodass man die Inhalte aufnehmen kann.
    </P>

    <P>
      Um die genannte Möglichkeit (CSS Media Queries) für seine
      eigene Webseite nutzen zu können, muss sich der Entwickler den
      Maßen der Bildschirme bewusst sein, auf die die Webseite in
      visueller Hinsicht optimiert werden soll.
    </P>

    <P>
      Da es sehr anstrengend ist, sämtliche Maße der - sich derzeit auf dem
...
@media screen and (max-device-width: 480px) {} // HTC HD2, Thunderbolt`}
    ...
    <P>
      Nun kommen wir zu den etwas größeren Geräten wie z.B. Tablets. Bei
...
@media (max-device-width: 768px) and (orientation: portrait) {}`}
    ...
    <P>
      Wie es den oberen CSS-Codes bereits entnommen werden kann, stehen die beiden
    ...
    <P>
      Ich hoffe ich konnte mit diesem Artikel denjenigen helfen, die es
      ...
      auch
      {' '}
      <Link href="http://nmsdvid.com/snippets/">hier</Link>
      {' '}
      gratis zu finden.
    </P>
  </Post>
