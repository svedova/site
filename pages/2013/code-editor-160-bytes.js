...
export default () => (
  <Post>
    ...
    <P>
      Ein paar JavaScript-Freaks aus Frankreich, Norwegen und
      Deutschland haben sich vor kurzem zusammengefunden, um
      ihre Idee des kleinsten Code-Editors der Welt zu
      verwirklichen. Dies ist ihnen anscheinend auch gelungen.
    </P>

    <P>
      Der Editor umfasst jeweils ein Textfeld für HTML-, CSS- sowie für
      ...
      voll funktionsfähigen Code-Editor:
    </P>
    ...
    <P>
      Auf der
      {' '}
      <Link href="http://xem.github.io/miniCodeEditor/minimal.html">
        Homepage
      </Link>
      {' '}
      des
      ...
      mittels einer URL zu teilen.
    </P>

    <P>
      Hierfür ist (wie sich einige unter euch jetzt denken werden) keine
      Datenbank nötig. Warum? - Ganz einfach: Die eingegebenen
      HTML-, JS- und CSS-Codes werden formatiert und direkt in der URL gesichert.
    </P>

    <P>
      Wer möchte kann sich dann auch noch aus 6 verschiedenen Anordnungen
