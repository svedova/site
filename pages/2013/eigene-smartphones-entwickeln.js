...
export default () => (
  <Post>
    ...
    <P>
      Vor ein paar Stunden kam ich durch einen Link auf eine ganz besondere
      ...
      Nutzer selbst anpassbar sind.
    </P>

    <P>
      Dave Hakkens - so heißt der selbsternannte Designer, welcher
      ...
      direkt entsorgt werden sobald sie nicht mehr funktionieren.
    </P>

    <P>
      Auf der offiziellen Webseite seiner Idee beruft sich der Niederländer
      ...
      App-Store ganz einfach ausgetauscht werden kann.
    </P>

    <Quote by="Dave Hakkens">
      If a blok breaks you can easily
      replace it, if it{`'`}s getting old just upgrade.
    </Quote>

    <P>
      Weitergehend wird auch das wohl größte Problem eliminiert: Da sich
    ...
    <P>
      Ich bin mir nicht sicher ob das ganze wirklich so leicht realisiert
