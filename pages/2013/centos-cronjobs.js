...
export default () => (
  <Post>
    ...
    <P>
      Vor wenigen Tagen bekam ich einen Auftrag bezüglich der Erstellung
      ...
      Operationen - persönlicher Favorit Linux/Unix.
    </P>

    <P>
      Da ich derzeit leider keine unbenutzen Lizenzen für eine
      Verwaltungssoftware besitze, musste ich alle nötigen Programme
      wie eine Websoftware (Apache), PHP, MySQL sowie einen
      FTP-Server mit Mirror manuell konfigurieren.
    </P>

    <P>
      Auf der Homepage befindet sich ein ein Counter, welcher alle
    ...
    <P>
      Um diese Aktion zu ermöglichen, entschied ich mich für einen
...
crontab -l	[Alle Cronjobs nach Erstellungsdatum auflisten]`}
    ...
    <P>
      Nun starte ich die Erstellung einer neuen Cron-Aufgabe
      mittels <InlineCode>crontab -e</InlineCode>. Dies wird den Editor
      öffnen, in den ich dann den Syntax für den gewünschten
      Cron-Task eingebe. Dieser wird mit Hilfe des folgenden Schemas aufgebaut:
    </P>

    <Image src="/static/essays/2013/cronjob-aufbau.png" />

    <P>
      Wie oben schon beschrieben möchte ich, dass jeden Tag um genau 8:30 Uhr
    ...
    <P>
      Nun fügen die gewünschte Sache ein, die ausgeführt werden soll. Dies
      ...
      auszuführen. Der Dateipfad für die Executable ist:
      {' '}
      <InlineCode>/usr/bin/php</InlineCode>
      .
    </P>

    <P>
      Dahinter fügen wir den Pfad zur PHP-Datei ein, welche
    ...
    <P>
      Nun sind wir fast am Ende angekommen. Jedoch steht noch eine wichtige
      ...
      versendet. Somit an meine Adresse.
    </P>

    <P>
      Da diese Art von Datenverkehr aber sehr nervig ist, möchte ich, dass
...
> /var/www/html/backup.log 2>&1`}
    ...
    <P>
      Nun bin ich fertig - das Script wird täglich um 8:30 Uhr
