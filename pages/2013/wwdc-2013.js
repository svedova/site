...
export default () => (
  <Post>
    ...
    <P>
      Heute Abend war es mal wieder soweit: Apple hielt eine offizielle
      ...
      neue
      {' '}
      <Link href="https://ssl.apple.com/ios/ios7/features/">iOS 7</Link>
      {' '}
      sowie
      der neue Mac Pro.
    </P>
    ...
    <P>
      Zunächst wurde ein wenig über Apples erreichte Ziele geredet: Mehr
      ...
      sowie über 50 Milliarden Downloads.
    </P>

    <P>
      Apple hat es anscheinend mal wieder geschafft, seine Nutzer und die, die
      ...
      von <b>60 GB pro Sekunde</b> (!) an. Das ist schon etwas besonderes.
    </P>

    <P>
      Ein weiteres Highlight war das neues Betriebssystem {`"`}iOS{`"`}, wessen
      siebte Version im vollen Umfang vorgestellt wurde. Mir
      persönlich gefällt das <b>neue UI-Design</b> sehr, genauso
      wie die verbesserte User-Experience und die neuen Apps.
    </P>

    <P>
      Das ganze ist nun im Grunde etwas einfacher aufgebaut, als vorher. Das
      ...
      zwischen iOS-Geräten übertragen können.
    </P>

    <P>
      Weitergehend wurde auch der Airport Extreme sowie die hauseigene
      Netzwerk-Festplatte {`"`}Time Capsule{`"`} weiterentwickelt
      um noch leichter mit den Geräten anderer Hersteller konkurrieren zu können.
    </P>

    <P>
      Alles in allem eine sehr gelungene Konferenz! Ich freue mich schon auf
