...
export default () => (
  <Post>
    ...
    <P>
      Time passes by so fast. It{`'`}s been about 3 months
      ...
      it as soon as I will find some time to create one.
    </P>

    <P>
      And now, around
      {' '}
      <Link href="https://github.com/leo/site/commits/master">120 commits</Link>
      {' '}
      later,
      ...
      need to open
      {' '}
      <Link href="https://ia.net/writer/mac/">iA Writer</Link>
      {' '}
      and let it flow.
    </P>

    <P>
      When I moved to from Tumblr to GitHub Pages a few
      ...
      I did that, I often heard and read that this method takes a price.
    </P>

    <P>
      And yes, of course it does. It{`'`}s not possible for me
    ...
    <P>
      ...
      remember
      {' '}
      <Link href="http://minecraft.net">Minecraft</Link>
      ? The game where
      ...
      do (when I{`'`}m out of creativity and need to recharge<Ref id="1" />). 🐓
    </P>

    <P>
      Just ask yourself why so many adults and kids love
      this game and therefore bought
      over
      {' '}
      <Link href="https://minecraft.net/stats">20.000.000 copies</Link>
      {' '}
      although
      it{`'`}s so easy to get a cracked version (not that I would
      recommend that, please keep supporting those Mojang guys and girls).
    </P>

    <P>
      The fact that you only have square blocks available to create
      ...
      effort that makes the game not-too-easy, but also not-too-hard.
    </P>

    <P><i>So how did we get here, exactly?</i></P>

    <P>
      Oh, yeah. You{`'`}re right. I originally just wanted to explain
    ...
    <P>
      I didn{`'`}t just create this new update because I was
      ...
      don{`'`}t want to miss on my personal one.
    </P>

    <P>
      Besides that, I also wanted to do some things which I had in
      my mind for a long time (since I started my first blog
      in 2013). So please, go ahead and check them out:
    </P>

    <H3>{`More "Leo", Less "Leonard Lamprecht"`}</H3>

    <P>
      I guess I literally wasted hundreds of hours thinking
      ...
      friends call me and how I also like to be called on the web.
    </P>

    <P>
      Besides the fact that the name is very easy to spell, it{`'`}s
      ...
      I also din{`'`}t know about this from the beginning.
    </P>

    <P>
      To cut a long story short: I thought it{`'`}s way easier for people to
    ...
    <P>
      I{`'`}m sure that many people will interpret that headline on
      ...
      abbreviation - not a new brand or something like that.
    </P>

    <H3>Fira? Fira!</H3>

    <P>
      If you{`'`}re an active contributor to Mozilla{`'`}s projects, or just
      know them pretty good, you{`'`}ll probably also know
      about <Link href="http://www.carrois.com/fira-4-1/">Fira</Link>.
    </P>
    ...
    <P>
      ...
      {`'`}
      s basically a new, open-source font
      ...
      rounded bottom of the letter <b>e</b>.
    </P>
    ...
    <P>
      ...
      typomaniac
      {' '}
      <Link href="https://en.wikipedia.org/wiki/Erik_Spiekermann">
        Erik Spiekermann
      </Link>
      {' '}
      in
      cooperation with the folks at
      {' '}
      <Link href="http://carrois.com">Carrois Type Design</Link>
      {' '}
      and
      is now widely used in Mozilla{`'`}s software palette.
    </P>

    <P>
      Since I don{`'`}t know that much about typography yet, this font
      ...
      also properly styled in terms of weight, size and kerning.
    </P>

    <H3>Better feed</H3>

    <P>
      Since I released my first blog posts a few years ago, I always
      ...
      {' '}
      tag
      yet (therefore I never really got to experiment with it).
    </P>

    <P>
      But now, because the whole source code of my site is
      ...
      some information on how to format my post{`'`}s meta-data for the feed.
    </P>

    <P>
      Coming across different un-official documentation
      ...
      haven{`'`}t been chosen as carefully as in Atom (just to name a few):
    </P>
    ...
    <P>
      Things like that are important to me, because they make
      ...
      that kind of effort is always one I will value.
    </P>

    <P>
      But of course that wasn{`'`}t the only reason why I chose
      Atom (although it{`'`}s a pretty big one). Some other cool
      things which really convinced me:
    </P>
    ...
    <UL>
      <LI>
        ...
        t need a
        {' '}
        <InlineCode>isPermaLink</InlineCode>
        {' '}
        attribute
        anymore, if it contains a permalink.
      </LI>

      <LI>
        I felt like the image-element was really poorly designed
        in RSS, which was why I was really happy when I noticed that
        Atom introduced the logo- and icon-tags that simply contain
        the URL to the image - no width, height or other specifications.
      </LI>
      ...
      <LI>
        ...
        {' '}
        and&nbsp;
        <InlineCode>{`<uri>`}</InlineCode> tags.
      </LI>
    </UL>

    <P>
      So in the End, I{`'`}ve decided to go with Atom. If you
      experience any troubles with this change, please go ahead
      and let me know about it, so that I can quickly fix it.
    </P>

    <H3>What Else?</H3>

    <P>
      Apart from the changes you{`'`}ll actually notice when
      visiting my site, I{`'`}ve also added some subtle ones. For
      most people, those might be not as important as the
      upper ones, but for me, they are.
    </P>

    <H4>Semantic HTML</H4>

    <P>
      The last theme I used on this blog wasn{`'`}t really optimized
    ...
    <P>
      Starting with the way my articles are
    ...
    <P>
      Sure, there are still some things like the footnotes
      ...
      that{`'`}s how I{`'`}ve interpreted W3C{`'`}s explanation).
    </P>

    <H4>Less Code</H4>

    <P>
      The re-design fortunately allowed me to rethink how this
      ...
      SASS as similar to CSS as possible).
    </P>

    <P>
      If you want to find out more about what I did there, just
    ...
    <P>
      ...
      to
      {' '}
      <InlineCode>/notes</InlineCode>
      , which
      will make all existing links to my posts on the web completely useless.
    </P>

    <H2>What I Learned from This</H2>

    <P>
      Before I finish this article (probably one of
      the longest I{`'`}ve ever written), I want to leave a
      few words about how I actually came to this point where
      I figured out how my new site will look and work:
    </P>

    <P>
      <i>Insecure?</i> — Yeah, I guess that{`'`}s what describes my
      ...
      but then turned out to be bad after some time.
    </P>

    <P>
      But I think I found out what my problem was: I wanted
      ...
      change I wanted to apply next. And hell yeah — it worked!
    </P>

    <FootNotes>
      <Note id="1">
        And please, don{`'`}t ask me why the hell I
        sometimes place those chicken or pigs here and
        there, I just love these little icons sitting in
        between good looking typography.
      </Note>

      <Note id="2">
        I might write about the story of my
        family another time, I{`'`}m pretty sure you{`'`}ll find
        it interesting!
      </Note>

      <Note id="3">
        The most fonts I know don{`'`}t have
        that feature. The <b>l</b> letter is usually more
        of simple line than an actual letter.
      </Note>
    </FootNotes>
  </Post>
)
