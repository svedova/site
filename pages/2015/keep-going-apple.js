...
export default () => (
  <Post>
    ...
    <P>
      Over the last few years, the company I{`'`}m talking about
      didn{`'`}t contribute much when it comes to pushing the web
      forward (at least as far as I know). Their web browser
      {' '}
      {`"`}
      Safari
      {`"`}
      ...
      much regarding web standard support or even new features for developers.
    </P>

    <P>
      While other browsers like Chrome or Firefox quickly introduced
      ...
      also think you
      {`'`}
      ll agree with me when I say that it just looks gorgeous.
    </P>

    <P>
      Since Safari is pre-installed on OS X as well as on iOS, you
      ...
      s
      {' '}
      <Link href="http://www.w3schools.com/browsers/browsers_stats.asp">
        not like that
      </Link>
      . And
      ...
      are much more extensions for it available.
    </P>

    <P>
      And please, also don{`'`}t forget about the effort that Google made
      to promote it
      {`'`}
      s browser. As you might still know, they
      {`'`}
      ve created hundreds
      ...
      their
      {' '}
      <Link href="https://youtu.be/N8gvf60RWgw">TV ads</Link>
      . But now, after many
      ...
      that they{`'`}ll even open source Swift<Ref id="1" />.
    </P>

    <P>
      And no, that wasn
      {`'`}
      t even the full list of things they
      {`'`}
      ve implemented
      ...
      watching
      {' '}
      <Link href="https://developer.apple.com/videos/wwdc/2015/?id=501">
        the video
      </Link>
      {' '}
      of
    ...
    <P>
      While I{`'`}m very happy about this huge step into the right
      ...
      want to compete against others in this scene.
    </P>
    ...
    <FootNotes>
      <Note id="1">
        Some people said that Apple might use it
