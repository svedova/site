...
export default () => (
  <Post>
    ...
    <P>
      The two big Ds<Ref id="1" /> in the
      ...
      rapidly. <b>
        Nobody wants to just be really good at one thing
        instead of being so-so great on two domains.
      </b>
    </P>

    <P>
      When I ask them why, they mostly tell me that it{`'`}s good to know
      ...
      other people, I keep getting better in doing so.
    </P>

    <P>
      But I also noticed a bad aspect of the whole scenario: When I
      ...
      feels like my subconscious mind just cuts some parts off the initial idea.
    </P>

    <P>
      While talking about new projects and ideas with other
      ...
      is this article for? Well, I just want you to be in the know about that.
    </P>

    <P>
      Please don{`'`}t let the limits we{`'`}re currently facing (in the
      ...
      {' '}
      <mark>without getting adapted</mark>
      {' '}
      to existing ones!
    </P>
